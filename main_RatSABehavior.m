...
masterTable_nm = 'data_masterTable';
masterTable_flnm = ['.\', masterTable_nm, '.mat']; 
...
if createNewMasterTable
    mT = createMasterTable(beh_datapath, masterSheet_flnm, experimentKey_flnm, masterTable_flnm, maxLatency);
end
load(masterTable_flnm) % if you want what's loaded to be the table you just created - MAKE SURE masterTable_flnm IS SET CORRECTLY
